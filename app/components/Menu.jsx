export default function Menu(props) {
	...
	return (
		...
		>
			<div
				className={`size-full flex justify-center items-center bg-background transition-opacity duration-(--custom-duration) responsive-padding ${
					props.open ? "opacity-100" : "opacity-0"
				}`}
			>
				<ul className="group/list flex flex-col items-center justify-center w-full responsive-max-width">
